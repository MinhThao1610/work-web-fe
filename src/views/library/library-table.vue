...
const title = ref("Danh sách bài tri thức");
const items = [
    {
        text: "Danh sách bài tri thức",
        href: "/library/table",
    },
    {
        text: "Danh sách bài tri thức",
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">Danh sách bài viết Tri thức</h4>
                        <div class="text-end">
                                ...
                                <div class="col-xl-12">
                                    <div class="table-responsive mt-4 mt-xl-0">
                                        ...
                                        >
                                            ...
                                            <el-table-column prop="type" label="Loại" min-width="140" />
            ...
            >
                ...
                <span class="dialog-footer">
                    ...
                    <el-button type="primary" @click="deleteLib()">
                        Xóa
                    </el-button>
                </span>
                </template>

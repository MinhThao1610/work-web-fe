                            ...
                            <div class="card tasks-box" v-for="(data, index) of unassigned" :key="index">
                                <div class="card-body">
                                    <div class="d-flex mb-2">
                                        <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><router-link
                                                to="/apps/tasks-details">{{ data.title }}</router-link></h6>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="text-muted" id="dropdownMenuLink1"
                                                data-bs-toggle="dropdown" aria-expanded="false"><i
                                                    class="ri-more-fill"></i></a>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <li><router-link class="dropdown-item" to="/apps/tasks-details"><i
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <span class="badge badge-soft-primary me-1"
                                                v-for="(item, index) of data.features" :key="index">item</span>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <div class="avatar-group">
                                                <a href="javascript: void(0);" v-for="(item, index) of data.users"
                                                    :key="index" class="avatar-group-item" data-bs-toggle="tooltip"
                        ...
                        <form action="#">
                            <div class="row g-3">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <flat-pickr v-model="date1" placeholder="Select date" class="form-control"></flat-pickr>
                                </div><!--end col-->
                                <div class="col-lg-4">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mt-2 text-center">
                            <lottie class="avatar-xl" colors="primary:#405189,secondary:#f06548" :options="defaultOptions"

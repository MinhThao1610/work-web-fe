...
const getListCompany = async () => {
    tableData.value = [
        ...
        },
        {
            ...
            address: "ngõ 59, Đường Lê Đức Thọ, Nam Từ Liêm, Hà Nội",
            tim: "Production",
            isWorking: true,
        },
        {
            ...
            address: "Xóm Thượng, Yên Từ, Yên Mô, Ninh Bình",
            tim: "Production",
            isWorking: true,
        },
        {
            ...
            address: "Trung Hiếu Hạ, Thanh Hải, Thanh Liêm, Hà Nam",
            tim: "Biz",
            isWorking: true,
        },
        {
            id: '66666',
            name: "Mai Vũ Huyền Anh",
            phone: "0939894018",
            email: "huyenanh@gmail.com",
            address: "Thôn Chợ, Nghĩa Hưng, Vĩnh Tường, Vĩnh Phúc",
            tim: "HR",
            isWorking: true,
        },
        {

...
export default [
  ...
  },
  {
    ...
    component: () => import("../views/myWork/myWork"),
  },
  {
    path: "/company/workfeed",
    name: "workfeed",
    meta: { title: "Việc của tôi", authRequired: true },
    component: () => import("../views/workfeed/workfeed"),
  },
  {
    path: "/company/organization",
    name: "organization",
    meta: { title: "Tổ chức", authRequired: true },
    component: () => import("../views/organization/organization"),
  },
  {
    path: "/company/culture",
    name: "culture",
    meta: { title: "Văn hóa", authRequired: true },
    component: () => import("../views/culture/culture"),
  },
  {
    path: "/company/member",
    name: "members",
    meta: { title: "Thành viên", authRequired: true },
    component: () => import("../views/members/members"),
  },
  {
    path: "/company/library",
    name: "library",
    meta: { title: "Tri thức", authRequired: true },
    component: () => import("../views/library/library"),
  },
  {
    path: "/company/me",
    name: "personalPage",
    meta: { title: "Tôi", authRequired: true },
    component: () => import("../views/personalPage/personalPage"),
  },
  {
    path: "/tim/today",
    name: "today",
    meta: { title: "Hôm nay", authRequired: true },
  ...
  },
  {
    ...
    name: "companyEdit",
    meta: { title: "Chỉnh sửa công ty", authRequired: true },
    component: () => import("../views/company/company-edit"),
  },
  {
    path: "/employees/table",
    name: "employeesTable",
    meta: { title: "Danh sách nhân viên", authRequired: true },
    component: () => import("../views/employees/employees-table"),
  },
  {
    path: "/employees/view/:id",
    name: "employeeView",
    meta: { title: "Chi tiết nhân viên", authRequired: true },
    component: () => import("../views/employees/employee-form"),
  },
  {
    path: "/employees/edit/:id",
    name: "employeeEdit",
    meta: { title: "Chỉnh sửa nhân viên", authRequired: true },
    component: () => import("../views/employees/employee-form"),
  },
  {
    path: "/employees/create",
    name: "employeeCreate",
    meta: { title: "Thêm nhân viên", authRequired: true },
    component: () => import("../views/employees/employee-form"),
  },
  {
    path: "/tims/table",
    name: "timsTable",
    meta: { title: "Danh sách tim", authRequired: true },
    component: () => import("../views/list-tims/tims-table"),
  },
  {
    path: "/tims/view/:id",
    name: "timView",
    meta: { title: "Chi tiết team", authRequired: true },
    component: () => import("../views/list-tims/tim-form"),
  },
  {
    path: "/tims/create",
    name: "timCreate",
    meta: { title: "Tạo team", authRequired: true },
    component: () => import("../views/list-tims/tim-form"),
  },
  {
    path: "/tims/edit/:id",
    name: "timEdit",
    meta: { title: "Chỉnh sửa team", authRequired: true },
    component: () => import("../views/list-tims/tim-form"),
  },
  {
    path: "/library/table",
    name: "libraryTable",
    meta: { title: "Danh sách bài tri thức", authRequired: true },
    component: () => import("../views/library/library-table"),
  },
  {
    path: "/library/view/:id",
    name: "libraryView",
    meta: { title: "Chi tiết bài tri thức", authRequired: true },
    component: () => import("../views/library/library-form"),
  },
  {
    path: "/library/edit/:id",
    name: "libraryEdit",
    meta: { title: "Chỉnh sửa bài tri thức", authRequired: true },
    component: () => import("../views/library/library-form"),
  },
  {
    path: "/library/create",
    name: "libraryCreate",
    meta: { title: "Thêm bài tri thức", authRequired: true },
    component: () => import("../views/library/library-form"),
  },
  {
    path: "/milestone/table",
    name: "milestoneTable",
    meta: { title: "Danh sách bài văn hóa", authRequired: true },
    component: () => import("../views/milestone/milestone-table"),
  },
  {
    path: "/milestone/view/:id",
    name: "milestoneView",
    meta: { title: "Chi tiết bài văn hóa", authRequired: true },
    component: () => import("../views/milestone/milestone-form"),
  },
  {
    path: "/milestone/edit/:id",
    name: "milestoneEdit",
    meta: { title: "Chỉnh sửa bài văn hóa", authRequired: true },
    component: () => import("../views/milestone/milestone-form"),
  },
  {
    path: "/milestone/create",
    name: "milestoneCreate",
    meta: { title: "Thêm bài văn hóa", authRequired: true },
    component: () => import("../views/milestone/milestone-form"),
  },
  {
    path: "/",
